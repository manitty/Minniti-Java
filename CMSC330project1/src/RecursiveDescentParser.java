...
//                }
    ...
    private JPanel getPanel() throws Exception // gets tokens and store them in an array 
    {
 ...
 
        {
            ...
            if (tokensList.get(0).equalsIgnoreCase("Button"))  // if current token  = Button add button to panel. 
 
            {
                panel.add(new JButton(getComponetLabel(tokensList.get(1)))); //adds button to panel
            } 
 
            else if (tokensList.get(0).equalsIgnoreCase("Label"))  // adds blank layout
 
            {
                panel.add(new JLabel(getComponetLabel(tokensList.get(1))));
            } 
 
            else if (tokensList.get(0).equalsIgnoreCase("Textfield")) // adds text field to input number 
