...
public class floyd {
  	...
  	public static void main(String[] args) {
    	...
    	int[][] m = new int[5][5];
    	m[0][0] = 0; m[0][1] = 0; m[0][2] = 0; m[0][3] = 0; m[0][4]=2;
    	
    	m[1][0] = 2; m[1][1] = 0; m[1][2] = 0; m[1][3] =0; m[1][4]=0;
    	
    	m[2][0] = 0; m[2][1] = 0; m[2][2] = 2; m[2][3] = 2; m[2][4] = 0;
    	
    	m[3][0] = 0; m[3][1] = 0; m[3][2] = 2; m[3][3] = 0;m[3][4] = 0;
    	
    	m[4][0] = 2; m[4][1] = 0; m[4][2] = 2; m[4][3] = 0;m[4][4] =2;
