...
public FWarshall(int numberofvertice)
...
public void fwarshall(int adjacencymatrix[][])
...
FWarshall fwarshall= new FWarshall(numberofvertices);

fwarshall.fwarshall(adjacency_matrix);
